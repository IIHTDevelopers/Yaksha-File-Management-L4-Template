...
public class TestAutomation extends App {
	...
	public void test_click_available_example() throws IOException {
		...
		try {
			boolean click_available_example_succeed = Activities.click_download_option(driver, example_name);
	...
	public void test_check_file_exist_in_download_folder() throws IOException {
		...
		boolean testcase_status = true;
		try {
			boolean check_file_exist_in_download_folder_succeed = Activities.check_file_exist_in_download_folder(driver,
					file_name);
			System.out.println(
					"check_file_exist_in_download_folder_succeed " + check_file_exist_in_download_folder_succeed);
